...
const skillCategories = {
    ...
    tools: ['MediaPipe', 'OpenCV', 'MediaPipe Hands', 'BeautifulSoup', 'Selenium', 'SMTP', 'SendGrid', 'SQLite', 'PostgreSQL', 'Arduino', 'HC-SR04 ultrasonic sensor', 'piezo buzzer', 'LED', 'Natural Language Processing']
};
        ...
        >
            ...
            <ul className="group/list">
                {projects.map((project, idx) => (
                    <li key={idx} className="mb-12 pb-8 border-b border-gray-200 last:border-b-0">
